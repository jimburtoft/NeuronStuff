#!/usr/bin/env python3
"""
Single-core inference benchmark for SigLIP 384px on Trainium2 with LNC=1.

Expected performance: ~14.38 img/s, 69.56 ms latency
...
MODEL_FILE = "siglip_384_neuron_lnc1.pt"
NUM_WARMUP = 10
NUM_ITERATIONS = 50

print("=" * 80)
print("SigLIP 384px - Single Core Inference (LNC=1)")
print("=" * 80)
print(f"Configuration: LNC=1 (8 logical cores on trn2.3xlarge)")
